...
module MI_PERIFERICO (
    ...
    `ifndef SYNTHESIS
        initial begin
            assert_bad_addr_width: assert($bits(s_apb.PADDR) >= MI_PERIFERICO_pkg::MI_PERIFERICO_MIN_ADDR_WIDTH)
                else $error("Interface address width of %0d is too small. Shall be at least %0d bits", $bits(s_apb.PADDR), MI_PERIFERICO_pkg::MI_PERIFERICO_MIN_ADDR_WIDTH);
            assert_bad_data_width: assert($bits(s_apb.PWDATA) == MI_PERIFERICO_pkg::MI_PERIFERICO_DATA_WIDTH)
                else $error("Interface data width of %0d is incorrect. Shall be %0d bits", $bits(s_apb.PWDATA), MI_PERIFERICO_pkg::MI_PERIFERICO_DATA_WIDTH);
        end
    `endif
    ...
    always_comb begin
        ...
        decoded_reg_strb.IRQEN = cpuif_req_masked & (cpuif_addr == 8'hf0);
    ...
    always_ff @(posedge clk) begin
        if(rst) begin
            field_storage.CTRL.SIZE.value <= 3'h0;
        end else begin
    ...
    // Field: MI_PERIFERICO.CTRL.OFFSET
    always_comb begin
    ...
    assign hwif_out.STATUS.RESERVED1.value = 4'h0;
    assign hwif_out.STATUS.TX_LVL.value = 4'h0;
    assign hwif_out.STATUS.RESERVED2.value = 12'h0;
    // Field: MI_PERIFERICO.IRQEN.RX_FIFO_EMPTY
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
        next_c = field_storage.IRQEN.RX_FIFO_EMPTY.value;
        load_next_c = '0;
        if(decoded_reg_strb.IRQEN && decoded_req_is_wr) begin // SW write
            next_c = (field_storage.IRQEN.RX_FIFO_EMPTY.value & ~decoded_wr_biten[0:0]) | (decoded_wr_data[0:0] & decoded_wr_biten[0:0]);
            load_next_c = '1;
        end
        field_combo.IRQEN.RX_FIFO_EMPTY.next = next_c;
        field_combo.IRQEN.RX_FIFO_EMPTY.load_next = load_next_c;
    end
    always_ff @(posedge clk) begin
        if(rst) begin
            field_storage.IRQEN.RX_FIFO_EMPTY.value <= 1'h0;
        end else begin
            if(field_combo.IRQEN.RX_FIFO_EMPTY.load_next) begin
                field_storage.IRQEN.RX_FIFO_EMPTY.value <= field_combo.IRQEN.RX_FIFO_EMPTY.next;
            end
        end
    end
    assign hwif_out.IRQEN.RX_FIFO_EMPTY.value = field_storage.IRQEN.RX_FIFO_EMPTY.value;
    // Field: MI_PERIFERICO.IRQEN.RX_FIFO_FULL
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
        next_c = field_storage.IRQEN.RX_FIFO_FULL.value;
        load_next_c = '0;
        if(decoded_reg_strb.IRQEN && decoded_req_is_wr) begin // SW write
            next_c = (field_storage.IRQEN.RX_FIFO_FULL.value & ~decoded_wr_biten[1:1]) | (decoded_wr_data[1:1] & decoded_wr_biten[1:1]);
            load_next_c = '1;
        end
        field_combo.IRQEN.RX_FIFO_FULL.next = next_c;
        field_combo.IRQEN.RX_FIFO_FULL.load_next = load_next_c;
    end
    always_ff @(posedge clk) begin
        if(rst) begin
            field_storage.IRQEN.RX_FIFO_FULL.value <= 1'h0;
        end else begin
            if(field_combo.IRQEN.RX_FIFO_FULL.load_next) begin
                field_storage.IRQEN.RX_FIFO_FULL.value <= field_combo.IRQEN.RX_FIFO_FULL.next;
            end
        end
    end
    assign hwif_out.IRQEN.RX_FIFO_FULL.value = field_storage.IRQEN.RX_FIFO_FULL.value;
    // Field: MI_PERIFERICO.IRQEN.TX_FIFO_EMPTY
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
        next_c = field_storage.IRQEN.TX_FIFO_EMPTY.value;
        load_next_c = '0;
        if(decoded_reg_strb.IRQEN && decoded_req_is_wr) begin // SW write
            next_c = (field_storage.IRQEN.TX_FIFO_EMPTY.value & ~decoded_wr_biten[2:2]) | (decoded_wr_data[2:2] & decoded_wr_biten[2:2]);
            load_next_c = '1;
        end
        field_combo.IRQEN.TX_FIFO_EMPTY.next = next_c;
        field_combo.IRQEN.TX_FIFO_EMPTY.load_next = load_next_c;
    end
    always_ff @(posedge clk) begin
        if(rst) begin
            field_storage.IRQEN.TX_FIFO_EMPTY.value <= 1'h0;
        end else begin
            if(field_combo.IRQEN.TX_FIFO_EMPTY.load_next) begin
                field_storage.IRQEN.TX_FIFO_EMPTY.value <= field_combo.IRQEN.TX_FIFO_EMPTY.next;
            end
        end
    end
    assign hwif_out.IRQEN.TX_FIFO_EMPTY.value = field_storage.IRQEN.TX_FIFO_EMPTY.value;
    // Field: MI_PERIFERICO.IRQEN.TX_FIFO_FULL
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
        next_c = field_storage.IRQEN.TX_FIFO_FULL.value;
        load_next_c = '0;
        if(decoded_reg_strb.IRQEN && decoded_req_is_wr) begin // SW write
            next_c = (field_storage.IRQEN.TX_FIFO_FULL.value & ~decoded_wr_biten[3:3]) | (decoded_wr_data[3:3] & decoded_wr_biten[3:3]);
            load_next_c = '1;
        end
        field_combo.IRQEN.TX_FIFO_FULL.next = next_c;
        field_combo.IRQEN.TX_FIFO_FULL.load_next = load_next_c;
    end
    always_ff @(posedge clk) begin
        if(rst) begin
            field_storage.IRQEN.TX_FIFO_FULL.value <= 1'h0;
        end else begin
            if(field_combo.IRQEN.TX_FIFO_FULL.load_next) begin
                field_storage.IRQEN.TX_FIFO_FULL.value <= field_combo.IRQEN.TX_FIFO_FULL.next;
            end
        end
    end
    assign hwif_out.IRQEN.TX_FIFO_FULL.value = field_storage.IRQEN.TX_FIFO_FULL.value;
    // Field: MI_PERIFERICO.IRQEN.MAX_DROP
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
        next_c = field_storage.IRQEN.MAX_DROP.value;
        load_next_c = '0;
        if(decoded_reg_strb.IRQEN && decoded_req_is_wr) begin // SW write
            next_c = (field_storage.IRQEN.MAX_DROP.value & ~decoded_wr_biten[4:4]) | (decoded_wr_data[4:4] & decoded_wr_biten[4:4]);
            load_next_c = '1;
        end
        field_combo.IRQEN.MAX_DROP.next = next_c;
        field_combo.IRQEN.MAX_DROP.load_next = load_next_c;
    end
    always_ff @(posedge clk) begin
        if(rst) begin
            field_storage.IRQEN.MAX_DROP.value <= 1'h0;
        end else begin
            if(field_combo.IRQEN.MAX_DROP.load_next) begin
                field_storage.IRQEN.MAX_DROP.value <= field_combo.IRQEN.MAX_DROP.next;
            end
        end
    end
    assign hwif_out.IRQEN.MAX_DROP.value = field_storage.IRQEN.MAX_DROP.value;
    assign hwif_out.IRQEN.RESERVED.value = 27'h0;
    // Field: MI_PERIFERICO.IRQ.RX_FIFO_EMPTY
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: MI_PERIFERICO.IRQ.RX_FIFO_FULL
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: MI_PERIFERICO.IRQ.TX_FIFO_EMPTY
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: MI_PERIFERICO.IRQ.TX_FIFO_FULL
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: MI_PERIFERICO.IRQ.MAX_DROP
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    assign hwif_out.IRQ.RESERVED.value = 27'h0;
    ...
    assign readback_array[2][0:0] = (decoded_reg_strb.IRQEN && !decoded_req_is_wr) ? field_storage.IRQEN.RX_FIFO_EMPTY.value : '0;
    assign readback_array[2][1:1] = (decoded_reg_strb.IRQEN && !decoded_req_is_wr) ? field_storage.IRQEN.RX_FIFO_FULL.value : '0;
    assign readback_array[2][2:2] = (decoded_reg_strb.IRQEN && !decoded_req_is_wr) ? field_storage.IRQEN.TX_FIFO_EMPTY.value : '0;
    assign readback_array[2][3:3] = (decoded_reg_strb.IRQEN && !decoded_req_is_wr) ? field_storage.IRQEN.TX_FIFO_FULL.value : '0;
    assign readback_array[2][4:4] = (decoded_reg_strb.IRQEN && !decoded_req_is_wr) ? field_storage.IRQEN.MAX_DROP.value : '0;
    assign readback_array[2][31:5] = (decoded_reg_strb.IRQEN && !decoded_req_is_wr) ? 27'h0 : '0;
